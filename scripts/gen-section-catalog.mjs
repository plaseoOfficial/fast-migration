...
lines.push(
  "When a page is marked **Privat**, build it from this canonical section order " +
    "(derived from `/leistungen/moebel-nach-mass`). Wrap everything in " +
    "`PrivatPageLayout` (Header + `<main className=\"flex flex-col\">` + Footer) and keep " +
    "page `metadata` in the route file. The two CTA blocks are `ExpandingImageCta` wrapped " +
    "in a beige `<section>` with the noted padding.",
);
lines.push("");
lines.push(table([
  ["#", "Section", "Library id"],
