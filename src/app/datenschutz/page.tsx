...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutzerklärung von Fast Systemmöbel, Inh. Johann Fast, Espelkamp – Informationen zur Verarbeitung personenbezogener Daten gemäß DSGVO.",
  ...
  return (
    <LegalPageLayout title="Datenschutzerklärung">
      ...
      <p>
        ...
        ein berechtigtes Interesse an einer möglichst zuverlässigen und sicheren Darstellung unserer
      ...
      <p>
        ...
        sowie – soweit anwendbar – auf die Zertifizierung des Anbieters unter dem EU-U.S. Data
        Privacy Framework gestützt.
      </p>
      ...
      <p>
        ...
        datenschutzrechtlich nicht sicheren Drittstaaten (z. B. Vercel, Google und Resend). Wenn
        diese Tools aktiv sind, können Ihre personenbezogene Daten in diese Drittstaaten übertragen
        und dort verarbeitet werden. Wir weisen darauf hin, dass in diesen Ländern kein mit der EU
        vergleichbares Datenschutzniveau garantiert werden kann. Beispielsweise sind US-Unternehmen
      ...
      <p>
        Unsere Website nutzt die Consent-Technologie von Cookiebot, um Ihre Einwilligung zur
        ...
        die Cybot A/S, Havnegade 39, 1058 Kopenhagen, Dänemark (nachfolgend „Cookiebot“).
      </p>
      <p>
        Wenn Sie unsere Website betreten, wird eine Verbindung zu den Servern von Cookiebot
        hergestellt, um Ihre Einwilligungen und sonstige Erklärungen zur Cookie-Nutzung einzuholen.
        Anschließend speichert Cookiebot ein Cookie in Ihrem Browser, um die erteilten
        Einwilligungen bzw. deren Widerruf zuordnen zu können. Die so erfassten Daten werden
        gespeichert, bis Sie uns zur Löschung auffordern, das Cookiebot-Cookie selbst löschen oder
        der Zweck für die Datenspeicherung entfällt. Zwingende gesetzliche Aufbewahrungsfristen
        bleiben unberührt.
      </p>
      <p>
      ...
      <p>
        Der technische Versand der über das Formular eingegebenen Daten erfolgt über den Dienst
        Resend. Anbieter ist die Resend, Inc., 2261 Market Street #5039, San Francisco, CA 94114,
        USA (nachfolgend „Resend“). Resend verarbeitet die von Ihnen übermittelten Daten (Name,
        E-Mail-Adresse, Telefonnummer, Nachricht) ausschließlich, um Ihre Anfrage als E-Mail an uns
        zuzustellen. Die hiermit verbundene Datenübertragung in die USA wird auf die
        Standardvertragsklauseln der EU-Kommission gestützt; mit Resend haben wir einen Vertrag über
      ...
      <p>
        ...
        Klicks aufzeichnen. Ferner verwendet Google Analytics verschiedene Modellierungsansätze, um
        die erfassten Datensätze zu ergänzen und setzt Machine-Learning-Technologien bei der
        Datenanalyse ein.
      </p>
      <p>
      ...
      <p>
        Wir nutzen Google Signals. Wenn Sie unsere Website besuchen, erfasst Google Analytics u. a.
        Ihren Standort, Suchverlauf und YouTube-Verlauf sowie demografische Daten (Besucherdaten).
        Diese Daten können mithilfe von Google Signals für personalisierte Werbung verwendet werden.
        Wenn Sie über ein Google-Konto verfügen, werden die Besucherdaten von Google Signals mit
        Ihrem Google-Konto verknüpft und für personalisierte Werbebotschaften verwendet. Die Daten
        werden außerdem für die Erstellung anonymisierter Statistiken zum Nutzerverhalten unserer
        Websitebesucher verwendet.
      </p>

      <h4>Google Ads / Remarketing</h4>
      <p>
        Wir nutzen die Werbefunktionen von Google (z. B. Google Ads und Remarketing), um auf Basis
        Ihres Nutzungsverhaltens interessenbezogene Werbung auszuspielen und den Erfolg unserer
        Werbekampagnen zu messen (Conversion-Tracking). Diese Funktionen werden nur nach Ihrer
        Einwilligung aktiviert (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG). Die Einwilligung
      ...
      <p>
        ...
        Wenn Google Maps aktiviert ist, kann Google zum Zwecke der einheitlichen Darstellung der
        Schriftarten Google Web Fonts verwenden. Beim Aufruf von Google Maps lädt Ihr Browser die
      ...
      <p>
        ...
        Orte. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
        ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit
        die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät
        des Nutzers (z. B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die Einwilligung ist
        jederzeit widerrufbar.
