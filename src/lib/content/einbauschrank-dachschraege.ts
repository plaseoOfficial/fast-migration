...
export const dachWarum = {
  ...
  paragraph:
    "Unter dem Dach passt kein Standardmaß. Fertigschränke und Modelle von der Stange enden dort, wo die Schräge beginnt, und über dem Schrank bleibt ein toter Winkel offen. Auch ein IKEA-Schrank oder PAX steht senkrecht im Raum und lässt die Schräge ungenutzt. Wir bauen den Schrank stattdessen zentimetergenau bis unter die Schräge, mit Fronten, die dem Winkel exakt folgen. Kniestock, Abseite und die flache Zone ganz hinten werden so vom Problem zur Stellfläche. Genau die verwinkelten Räume, an denen Standardmöbel scheitern, sind für uns Alltag.",
  images: [
    {
