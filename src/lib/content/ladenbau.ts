...
export const ladenGeschichte = {
  ...
  paragraphs: [
    ...
    "Vom einzelnen Tresen über die Boutique bis zur Filialausstattung in Serie fertigen wir in Espelkamp, montieren im Umkreis von rund 200 km und liefern deutschlandweit. Mehr Projekte aus dem Einzelhandel und Gewerbe zeigen unsere [Referenzprojekte](/referenzen/).",
  ],
};
